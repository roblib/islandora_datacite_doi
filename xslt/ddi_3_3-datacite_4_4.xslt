...
<xsl:stylesheet 
                ...
                xmlns:ddi="ddi:instance:3_2 https://ddialliance.org/Specification/DDI-Lifecycle/3.3/XMLSchema/instance.xsd"
    ...
    <!--
    Document   : ddi_3_2-datacite_4_4.xsl
    Version    : development
    ...
    application/x-R-2
    -->
    <xsl:param name="formats">application/xml;vocabulary=ddi,version=3.2</xsl:param>
